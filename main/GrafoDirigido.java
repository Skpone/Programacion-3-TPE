...
public class GrafoDirigido<T> implements Grafo<T> {
	...
	public void agregarVertice(int verticeId) {
        ...
        /**
         * Complejidad: O(n^2) porque se deben obtener todos los arcos y recorrerlos,
         * luego por cada arco, si cumple con la condición, borrarlo (.borrarArco() == O(n)).
         */
	@Override
	public void borrarVertice(int verticeId) {
        ...
        /**
         * Complejidad: O(n) porque requerimos saber si el arco ya existe en la lista de arcos del vertice,
         * el peor caso requiere recorrer "n"; la cantidad de elementos dentro de la lista.
         */
	@Override
	public void agregarArco(int verticeId1, int verticeId2, T etiqueta) {
         ...
         * para saber si el arco existe dentro de la lista de arcos (.contains())
	...
	public boolean contieneVertice(int verticeId) {
        ...
        /**
         * Complejidad: O(n) porque en el metodo contains() requerimos saber si el arco existe dento de la lista de arcos del vertice.
	...
	public Arco<T> obtenerArco(int verticeId1, int verticeId2) {
        ...
        /**
         * Complejidad: O(1), pedir el tamaño de una lista no requiere ningun tipo de recorrido (por ejemplo).
         */
	@Override
	public int cantidadVertices() {
        ...
        /**
         * Complejidad: O(n) n siendo la cantidad de vertices (cantidad de listas de arcos) que tengamos en nuestro HashMap,
         * debemos recorrer las listas preguntando por su tamaño
         */
	@Override
	public int cantidadArcos() {//O(n)
        ...
        /**
         * Complejidad: O(1), aplicamos O(1) de complejidad a cualquier metodo del HashMap
         */
	@Override
	public Iterator<Integer> obtenerVertices() {
        ...
        /**
         * Complejidad: O(n) n siendo la cantidad de arcos del vertice, al requerir recorrerlos para obtener
         * los adyacentes del vertice.
         */
	@Override
	public Iterator<Integer> obtenerAdyacentes(int verticeId) {
        ...
        /**
         * Complejidad: O(V*a) porque tenemos que recorrer dependiendo de la cantidad de vertices que estén en nuestro grafo,
         * agregamos todos sus arcos a una lista y esa tarea implica recorrido de la LinkedList de los arcos del vertice a la que instanciamos.
         */
	@Override
	public Iterator<Arco<T>> obtenerArcos() {
        ...
        /**
         * Complejidad: O(1) porque obtener la LinkedList desde el HashMap y llamar su iterator no varia por el tamaño de la entrada.
         */
	@Override
